    ...
    <div >
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#111827] ">
          {/* <a href="#" className="flex gap-2 items-center ps-2.5 mb-5">
                    ...
                    <div className='flex'>
                        <FaUserCircle className='text-white mr-2' size={32} />
                            <div className='text-white text-left'>
                                    <span className="self-center text-2xl font-semibold whitespace-nowrap">KLES</span>
                                    <p>Manager</p>
                            </div>
                    </div>
                </div>
          <ul className="space-y-2 font-medium">
            ...
            <li onClick={toggleNavbar}>
              ...
              <PiBriefcaseFill size={22} className='text-[#9CA3AF] group-hover:text-white'/>
                ...
                <span className="ms-3">Job Requests</span>
              </Link>
            </li>
            <li onClick={toggleNavbar}>
              <Link
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
              <TiMessages size={22} className='text-[#9CA3AF] group-hover:text-white'/>
            ...
            <li onClick={toggleNavbar}>
              <Link
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
              <FaBell size={22} className='text-[#9CA3AF] group-hover:text-white'/>
